        ...
        <div class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 my-5 border-top">
            ...
            <div class="col mb-3">
                ...
                <ul class="list-unstyled text-small">
                    ...
                    <li><a class="link-secondary" href="#">Recettes</a></li>
            ...
            <div class="col mb-3">
                ...
                <p class="text-body-secondary">Site communautaire de partage de recettes de cuisine.</p>
            </div>

            <div class="col mb-3">
                <h5>Nous contacter</h5>
                <p>contact@casserole-en-folie.com</p>
            </div>
        </div>
    </div>
</footer>
